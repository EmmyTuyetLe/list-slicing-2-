...
def custom_equality(some_list, another_list):
    ...
    """
    length_of_some_list = custom_len(some_list)
    length_of_another_list = custom_len(another_list)
    if length_of_some_list != length_of_another_list:
        return False

    for i in range(length_of_some_list):
